...
description: "Minimum Viable Data Architecture"
icon: "database"
---
...
| Token Allocation        | `Richtext`      | Allocation of Governance Tokens or Loot Tokens for stakeholders if using a Blockchain-based Governance Mechanism.               |
...
| Target Market           | `Multiselect`   | Selection of the target audience based on the crop selection, desired financial returns, quality of harvest, and project goals. |