...
flowchart LR
    ...
    style WH fill:#d1fae5,stroke:#10b981,color:#065f46
    style HM fill:#d1fae5,stroke:#10b981,color:#065f46
    style CO fill:#d1fae5,stroke:#10b981,color:#065f46
    style RI fill:#fee2e2,stroke:#ef4444,color:#991b1b
    style PG fill:#009F4D,stroke:#009F4D,color:#ffffff

    style ECO fill:#ecfdf5,stroke:#10b981,color:#065f46
    style ECO2 fill:#dbeafe,stroke:#3b82f6,color:#1e40af
    style COM fill:#ede9fe,stroke:#8b5cf6,color:#4c1d95
    style KNOW fill:#fef3c7,stroke:#f59e0b,color:#92400e
```
