...
<iframe src="https://www.youtube.com/embed/ZxEdvQe1JNk" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
...
- [**Ecological Census Map**](https://kokonut.network/resources/Species-Adelphi.pdf)