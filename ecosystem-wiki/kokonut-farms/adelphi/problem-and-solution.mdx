...
Limited employment
      │
      ▼
Reduced household income → food insecurity → poor nutrition
      │
      ▼
Agricultural abandonment → deforestation → soil degradation
      │
      ▼
Less productive land → less income → more abandonment
      │
Compounded by:
Cultural disconnection (knowledge gap) +
Lack of community spaces (coordination gap) +
Gender barriers (leadership gap)
```
