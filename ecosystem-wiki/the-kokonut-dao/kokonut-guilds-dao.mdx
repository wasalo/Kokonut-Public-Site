...
```mermaid
flowchart TD
    M["🏛️ Kokonut Moloch DAO\nTreasury · Token holders · Rage-quit\nApproves funding, priorities and scale"]

    G["⚙️ Guild Layer\nTech · Impact · Comms · Governance · Finance · CPs\nCoordinates domain expertise and execution"]

    W["🛠️ Work Execution\nTasks · milestones · partner coordination\nFarm operations · software · reporting"]

    C["📊 Contribution Accounting\nGuild Points · deliverables · work evidence\nUsed for rewards, trust and future proposals"]

    M -->|"funding + strategic mandates"| G
    G -->|"coordinates contributors"| W
    W -->|"completed work + evidence"| C
    C -->|"reports + funding proposals"| M

    style M fill:#ede9fe,stroke:#8b5cf6,color:#4c1d95
    style G fill:#d1fae5,stroke:#10b981,color:#065f46
    style W fill:#fef3c7,stroke:#f59e0b,color:#92400e
